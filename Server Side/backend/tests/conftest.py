...
os.environ.setdefault("DB_PASS", "test_db_pass")
...
os.environ.setdefault("INFLUX_PASS", "test_influx_pass")
os.environ.setdefault("INFLUX_DB", "test")
os.environ.setdefault("MQTT_BROKER_HOST", "localhost")
os.environ.setdefault("MQTT_BROKER_PORT", "1883")
os.environ.setdefault("MQTT_USERNAME", "test")
os.environ.setdefault("MQTT_PASSWORD", "test_mqtt_pass")
...
os.environ.setdefault("RPI_WEBHOOK_SECRET", "test_rpi_webhook_secret_value")
